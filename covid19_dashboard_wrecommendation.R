...
###########################################
#DEAR READER: This turned out as a unnecessary large shit pile of code over time and I would optimise it with modules.
#However, time´s rare, hope no one cares.
###########################################
